...
function populateTeamPickers(match){
  ...
  selects.forEach((sel, i) => {
    const keepValue = sel.value && match.players.includes(sel.value) ? sel.value : match.players[i];
...
document.getElementById('btn-save-result').addEventListener('click', () => {
  ...
  const result = { setsA, setsB, gamesA, gamesB, teamA, teamB };
